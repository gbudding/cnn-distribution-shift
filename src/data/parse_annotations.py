...
def parse_xml(xml_path: str, data_root: str) -> List[Tuple[str, int]]:
    ...
    Parameters
    ----------
    xml_path  : path to species XML, e.g. 'tiny_data/wheat_tiny.xml'
...
if __name__ == "__main__":
    ...
    parser.add_argument("xml",  help="Path to XML, e.g. tiny_data/wheat_tiny.xml")
    parser.add_argument("root", help="Image root, e.g. tiny_data/wheat")
