...
def main(args):
    ...
    print(f"  python src/models/train.py --datalist {args.out} --out runs/checkpoints/wheat_tiny --device cpu")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--xml",  default=None,
                        help="Path to species XML (e.g. data/tiny_data/wheat_tiny.xml)")
